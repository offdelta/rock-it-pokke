...
export default function RabbitAnimation() {
  ...
  return (
    <div className="rabbit-container relative w-32 h-32 mx-auto mb-8">
      <div className="pocket absolute bottom-0 left-1/2 transform -translate-x-1/2 w-20 h-12 rounded-t-full shadow-inner border-2" style={{backgroundColor: '#4d6f4d', borderColor: '#3d5a3d'}}></div>
